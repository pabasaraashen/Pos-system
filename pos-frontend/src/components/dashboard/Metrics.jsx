  ...
  return (
    <div className='container mx-auto py-2 px-6 md:px-4'>
      <div className='flex justify-between items-center'>
        <div>
          <h2 className='font-semibold text-black text-2xl'>Overall Performance</h2>
          
        </div>
        <button className='flex items-center gap-2 bg-gray-200 hover:bg-gray-400 text-black py-2 px-4 rounded-lg'>
